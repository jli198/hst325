...
var bouncing_text; //our bouncing text object
...
function setup() {
	...
	bouncing_text = new bouncingText({
		text: "Hello, world!",
		size: 32,
...
function draw() {
	...
	bouncing_text.draw(); //run the draw() function of the bouncingText object we created	
